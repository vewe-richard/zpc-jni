...
#ifndef ZWAVE_COMMAND_CLASS_ZWAVEPLUS_INFO_HANDLERS_H
#define ZWAVE_COMMAND_CLASS_ZWAVEPLUS_INFO_HANDLERS_H
...
/**
 * @defgroup COMMAND_CLASS_ZWAVEPLUS_INFO_handler Command handlers for COMMAND_CLASS_ZWAVEPLUS_INFO
 * @brief Functions for controlling COMMAND_CLASS_ZWAVEPLUS_INFO
 * 
 * This module implement functions for generating and parsing the Z-Wave frames
 * for controlling COMMAND_CLASS_ZWAVEPLUS_INFO. The module builds frames by reading data from the
...
digraph G {
  ...
  COMMAND_CLASS_ZWAVEPLUS_INFO_VERSION [ label="COMMAND_CLASS_ZWAVEPLUS_INFO_VERSION\nV0\nget:", shape="ellipse" ]
  ep [ label="endpoint", shape="box"]
  ZWAVEPLUS_INFO_Z_WAVE_VERSION [ label="ZWAVEPLUS_INFO_Z_WAVE_VERSION\nV1\nget:ZWAVEPLUS_INFO_GET", shape="ellipse" ]
  ep [ label="endpoint", shape="box"]
  ZWAVEPLUS_INFO_ROLE_TYPE [ label="ZWAVEPLUS_INFO_ROLE_TYPE\nV1\nget:ZWAVEPLUS_INFO_GET", shape="ellipse" ]
  ep [ label="endpoint", shape="box"]
  ZWAVEPLUS_INFO_NODE_TYPE [ label="ZWAVEPLUS_INFO_NODE_TYPE\nV1\nget:ZWAVEPLUS_INFO_GET", shape="ellipse" ]
  ep [ label="endpoint", shape="box"]
  ZWAVEPLUS_INFO_INSTALLER_ICON_TYPE [ label="ZWAVEPLUS_INFO_INSTALLER_ICON_TYPE\nV2\nget:ZWAVEPLUS_INFO_GET", shape="ellipse" ]
  ep [ label="endpoint", shape="box"]
  ZWAVEPLUS_INFO_USER_ICON_TYPE [ label="ZWAVEPLUS_INFO_USER_ICON_TYPE\nV2\nget:ZWAVEPLUS_INFO_GET", shape="ellipse" ]

  ep -> COMMAND_CLASS_ZWAVEPLUS_INFO_VERSION
  ep -> ZWAVEPLUS_INFO_Z_WAVE_VERSION
  ep -> ZWAVEPLUS_INFO_ROLE_TYPE
  ep -> ZWAVEPLUS_INFO_NODE_TYPE
  ep -> ZWAVEPLUS_INFO_INSTALLER_ICON_TYPE
  ep -> ZWAVEPLUS_INFO_USER_ICON_TYPE
}
@enddot
...
/**
 * @brief Version of COMMAND_CLASS_ZWAVEPLUS_INFO which this handlers is genrated for
 * 
 */
...
/**
 * @brief Initialisation of COMMAND_CLASS_ZWAVEPLUS_INFO
 * 
...
/**
 * @brief Override function for ZWAVEPLUS_INFO_REPORT
 * 
 ...
 */
sl_status_t  zwave_ZWAVEPLUS_INFO_REPORT_handle_report_command_override(
  const zwave_controller_connection_info_t *connection_info,
  const uint8_t *frame,
  uint16_t frame_length) ;

/**
 * @brief Override function for ZWAVEPLUS_INFO_GET
 * 
...
sl_status_t zwave_ZWAVEPLUS_INFO_GET_override(
...
#endif  //ZWAVE_HANDLERS_COMMAND_CLASS_ZWAVEPLUS_INFO_H
