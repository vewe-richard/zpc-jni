...
#define SHADE_CONFIGURATION_STATUS_SHADE_ADJUSTING (0x02)
#define SHADE_CONFIGURATION_STATUS_SHADE_ADJUSTING_OFFSET (1)
#define SHADE_CONFIGURATION_STATUS_SHADE_DIRECTION (0x04)
#define SHADE_CONFIGURATION_STATUS_SHADE_DIRECTION_OFFSET (2)
#define SHADE_CONFIGURATION_STATUS_FORWARD_DIRECTION_OF_MOTOR (0x08)
#define SHADE_CONFIGURATION_STATUS_FORWARD_DIRECTION_OF_MOTOR_OFFSET (3)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_LEVEL (0x03)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_LEVEL_OFFSET (0)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_STROBE_ACTIVE (0x08)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_STROBE_ACTIVE_OFFSET (3)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_MODE (0xF0)
#define SQUAWK_SQUAWK_CONFIGURATION_SQUAWK_MODE_OFFSET (4)
#define START_WARNING_SIREN_CONFIGURATION_SIREN_LEVEL (0x03)
#define START_WARNING_SIREN_CONFIGURATION_SIREN_LEVEL_OFFSET (0)
#define START_WARNING_SIREN_CONFIGURATION_STROBE (0x0C)
